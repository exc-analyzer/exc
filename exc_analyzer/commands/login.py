import sys
import webbrowser
from exc_analyzer.print_utils import print_success, print_action, print_cancelled, safe_print, colorize, clear_screen, _write_output
...
def cmd_login(args):
    ...
    try:
        ...
        log(f"pyperclip not available: {e}")
